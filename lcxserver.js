...
var remotehost=net.createServer((sock)=>{
...
var linkhost=net.createServer((sock)=>{
        ...
        sock.on('data',(data)=>{
            if(data.toString().substr(0,7)=='connect'){
                ...
                if(sockpairs[key]){
                    ...
                    sockpairs[key].left.on('data',(data)=>{
                        sock.write(data);
                    })
                    sockpairs[key].left.on('end',()=>{
                        sock.end();
                    })
                    sockpairs[key].left.on('error',(err)=>{
